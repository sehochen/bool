<?php
  ...
  $res=mysql_query("select * from product limit $pagefrom,$pagesize");
...
<input type="button" name="cz6" id="cz9" value="新增产品" style="margin:5px;" onclick="javascript:window.location.href='product_list_add.php';" />

<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1">
  <tr class="x2">
    <td width="132" height="30" align="center" bgcolor="#999999">序号</td>
    <td width="300" height="30" align="center" bgcolor="#999999">标题</td>
    <td width="216" align="center" bgcolor="#999999">封面图</td>
...
<?php while($row = mysql_fetch_assoc($res)): ?>  
  ...
  <tr>
    <td height="30" align="center" bgcolor="#CCCCCC"><?php echo $row['p_id']; ?></td>
    <td height="30" align="left" bgcolor="#CCCCCC"><?php echo $row['p_title']; ?></td>
    <td align="center" bgcolor="#CCCCCC"><?php echo $row['p_img']; ?></td>
    <td height="30" align="center" bgcolor="#CCCCCC"><?php echo $row['p_time']; ?></td>
    <td height="30" align="center" bgcolor="#CCCCCC">
      <input type="button" name="cz" id="cz" value="修改" onclick="edit(<?php echo $row['p_id']; ?>)"/>
      <input type="button" name="cz2" id="cz2" value="删除" onclick="del(<?php echo $row['p_id']; ?>)"/>
    </td>
  </tr>
<?php endwhile; ?>
...
<script>
  function edit(id){
    window.location.href='product_list_update.php?id='+id;
  }

  function del(id){
    if(confirm('你真的要删除吗？') ){
      window.location.href='../delete.php?table=product&id='+id;
    }
  }  
