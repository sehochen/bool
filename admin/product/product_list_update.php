...
<input type="button" name="cz10" id="cz13" value="产品列表" onclick="javascript:window.location.href='product_list.php';" />

<form action="product_list_update_do.php" method="post" enctype="multipart/form-data">
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1">
  <tr class="x2">
    <td height="30" align="center" bgcolor="#999999" colspan="3">编辑产品</td>
  </tr>

  <tr>
    <td height="30" width="80" align="center" bgcolor="#CCCCCC">封面图</td>
    <td height="30" align="center" bgcolor="#CCCCCC">
      <input type="file" name="p_img" />
      <span><?php echo $info['p_img']; ?></span>
    </td>
    <input type="hidden" name="p_img" value="<?php echo $info['p_img']; ?>" />
  </tr>

  <tr>
    <td height="30" width="80" align="center" bgcolor="#CCCCCC">产品标题</td>
    <td height="30" align="center" bgcolor="#CCCCCC"><input type="text" name="p_title" value="<?php echo $info['p_title']; ?>" /></td>
  </tr>


  <tr>
    <td height="30" width="80" align="center" bgcolor="#CCCCCC">产品内容</td>
    <td height="30" align="center" bgcolor="#CCCCCC">
        ...
        <!-- 加载编辑器的容器 -->
        <script id="container" name="p_content" type="text/plain" style="width:95%;height:20em;"><?php echo $info['p_content']; ?></script>
