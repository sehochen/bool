<?php
  ...
  $res=mysql_query("select * from link limit $pagefrom,$pagesize");
...
<input type="button" name="cz6" id="cz9" value="添加链接" style="margin:5px;" onclick="javascript:window.location.href='link_add.php';" />
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1">
  <tr class="x2">
    ...
    <td width="216" align="center" bgcolor="#999999">地址</td>
...
<?php while($row = mysql_fetch_assoc($res)): ?>  
  ...
  <tr>
    <td height="30" align="center" bgcolor="#CCCCCC"><?php echo $row['l_id']; ?></td>
    <td height="30" align="left" bgcolor="#CCCCCC"><?php echo $row['l_title']; ?></td>
    <td align="center" bgcolor="#CCCCCC">
      <a href="<?php echo $row['l_url']; ?>" target="_blank"> 
        <?php echo $row['l_url']; ?> 
      </a>
    </td>
    <td height="30" align="center" bgcolor="#CCCCCC"><?php echo $row['l_time']; ?></td>
    <td height="30" align="center" bgcolor="#CCCCCC">
      <input type="button" name="cz" id="cz" value="编辑" onclick="edit(<?php echo $row['l_id']; ?>)"/>
      <input type="button" name="cz2" id="cz2" value="删除" onclick="del(<?php echo $row['l_id']; ?>)"/>
    </td>
  </tr>
<?php endwhile; ?>
...
<script>
  function edit(id){
    window.location.href='link_edit.php?id='+id;
  }

  function del(id){
    if(confirm('你真的要删除吗？') ){
      window.location.href='../delete.php?table=link&id='+id;
    }
  }  
