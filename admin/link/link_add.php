...
<form action="link_add_do.php" method="post" enctype="multipart/form-data">

<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1">
  <tr class="x2">
    <td height="30" align="center" bgcolor="#999999" colspan="3">添加链接</td>
  </tr>

  <tr>
    <td height="30" width="80" align="center" bgcolor="#CCCCCC">链接标题</td>
    <td height="30" align="center" bgcolor="#CCCCCC"><input type="text" name="l_title" /></td>
  </tr>

  <tr>
    <td height="30" width="80" align="center" bgcolor="#CCCCCC">链接地址</td>
    <td height="30" align="center" bgcolor="#CCCCCC"><input type="text" name="l_url" /></td>
  </tr>
