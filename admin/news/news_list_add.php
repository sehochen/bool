...
<form action="news_list_add_do.php" method="post" enctype="multipart/form-data">

<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1">
  <tr class="x2">
    <td height="30" align="center" bgcolor="#999999" colspan="3">新增新闻</td>
  </tr>

  <tr>
    <td height="30" width="80" align="center" bgcolor="#CCCCCC">新闻标题</td>
    <td height="30" align="center" bgcolor="#CCCCCC"><input type="text" name="n_title" /></td>
  </tr>
  ...
  <tr>
    ...
    <td height="30" align="center" bgcolor="#CCCCCC">
        ...
        <!-- 加载编辑器的容器 -->
        <script id="container" name="n_content" type="text/plain" style="width:95%;height:20em;"></script>
