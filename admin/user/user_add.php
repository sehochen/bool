...
<form action="user_add_do.php" method="post" enctype="multipart/form-data">

<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1">
  <tr class="x2">
    <td height="30" align="center" bgcolor="#999999" colspan="3">新增用户</td>
  </tr>
  <tr>
    <td height="30" height="100" align="right" bgcolor="#CCCCCC">姓名</td>
    <td height="30" align="center" bgcolor="#CCCCCC"><input type="text" name="u_name" /></td>
    <td height="30" align="left" bgcolor="#CCCCCC">*必填，不可忽略此内容</td>
  </tr>

  <tr>
    <td height="30" height="100" align="right" bgcolor="#CCCCCC">密码</td>
    <td height="30" align="center" bgcolor="#CCCCCC"><input type="password" name="u_pwd" /></td>
    <td height="30" align="left" bgcolor="#CCCCCC">*必填，不可忽略此内容</td>
  </tr>

  <tr>
    <td height="30" height="100" align="right" bgcolor="#CCCCCC">确认密码</td>
    <td height="30" align="center" bgcolor="#CCCCCC"><input type="password" name="u_c_pwd" /></td>
    <td height="30" align="left" bgcolor="#CCCCCC">*必填，不可忽略此内容</td>
  </tr>

  <tr>
    <td height="30" height="100" align="right" bgcolor="#CCCCCC">头像</td>
    <td height="30" align="center" bgcolor="#CCCCCC"><input type="file" name="u_img" /></td>
