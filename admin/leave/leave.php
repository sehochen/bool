<?php
  ...
  $res=mysql_query("select * from `leave` limit $pagefrom,$pagesize");
...
<?php while($row = mysql_fetch_assoc($res)): ?>  
  ...
  <tr>
    ...
    <td align="center" bgcolor="#CCCCCC"><?php echo $row['l_tel']; ?></td>
    <td height="30" align="center" bgcolor="#CCCCCC"><?php echo $row['l_time']; ?></td>
    <td height="30" align="center" bgcolor="#CCCCCC">
      <input type="button" name="cz" id="cz" value="查看" onclick="edit(<?php echo $row['l_id']; ?>)"/>
...
<script>
  function edit(id){
    window.location.href='leave_show.php?id='+id;
  }

  function del(id){
    if(confirm('你真的要删除吗？') ){
      window.location.href='../delete.php?table=leave&id='+id;
    }
  }  
