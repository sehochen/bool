<?php
  ...
  $res=mysql_query("select * from job limit $pagefrom,$pagesize");
...
<input type="button" name="cz6" id="cz9" value="发布招聘" style="margin:5px;" onclick="javascript:window.location.href='job_add.php';" />
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1">
  <tr class="x2">
    ...
    <!-- <td width="216" align="center" bgcolor="#999999">手机号</td> -->
...
<?php while($row = mysql_fetch_assoc($res)): ?>  
  ...
  <tr>
    <td height="30" align="center" bgcolor="#CCCCCC"><?php echo $row['j_id']; ?></td>
    <td height="30" align="left" bgcolor="#CCCCCC"><?php echo $row['j_title']; ?></td>
    <!-- <td align="center" bgcolor="#CCCCCC"><?php echo $row['j_tel']; ?></td> -->
    <td height="30" align="center" bgcolor="#CCCCCC"><?php echo $row['j_time']; ?></td>
    <td height="30" align="center" bgcolor="#CCCCCC">
      <input type="button" name="cz" id="cz" value="编辑" onclick="edit(<?php echo $row['j_id']; ?>)"/>
      <input type="button" name="cz2" id="cz2" value="删除" onclick="del(<?php echo $row['j_id']; ?>)"/>
    </td>
  </tr>
<?php endwhile; ?>
...
<script>
  function edit(id){
    window.location.href='job_edit.php?id='+id;
  }

  function del(id){
    if(confirm('你真的要删除吗？') ){
      window.location.href='../delete.php?table=job&id='+id;
    }
  }  
