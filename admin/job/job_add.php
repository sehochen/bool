...
<form action="job_add_do.php" method="post" enctype="multipart/form-data">
...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1">
  ...
  <tr>
    ...
    <td height="30" align="center" bgcolor="#CCCCCC"><input type="text" name="j_title" /></td>
  </tr>
  ...
  <tr>
    ...
    <td height="30" align="center" bgcolor="#CCCCCC">
        ...
        <!-- 加载编辑器的容器 -->
        <script id="container" name="j_content" type="text/plain" style="width:95%;height:20em;"></script>
